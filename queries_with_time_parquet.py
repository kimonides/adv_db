...
movies = spark.read.parquet("hdfs://master:9000/dbms_project/movies.parquet")
movies.createOrReplaceTempView("movies")
ratings = spark.read.parquet("hdfs://master:9000/dbms_project/ratings.parquet")
ratings.createOrReplaceTempView("ratings")
genres = spark.read.parquet("hdfs://master:9000/dbms_project/movie_genres.parquet")
...
for time in sql_times:
    print("Q",i,"total_run_time_in_seconds(paquet)",time)
    i=i+1
